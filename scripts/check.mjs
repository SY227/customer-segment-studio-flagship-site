...
const required = [
  'public/index.html', 'public/styles.css', 'public/app.js', 'public/assets/segment-studio-mark.svg',
  ...
  'docs/SOURCE_GROUNDING.md', 'docs/SCREENSHOT_SOURCES.md', 'docs/DESIGN_NOTES.md', 'README.md',
  'server.mjs', 'build.mjs', 'vercel.json'
];
...
for (const file of ['public/app.js', 'server.mjs', 'build.mjs', 'scripts/check.mjs', 'scripts/doctor.mjs']) {
...
console.log(`Customer Segment Studio flagship checks passed: ${required.length} required files, shorter commercial flow, three product tabs, no embedded app, no secrets.`);
